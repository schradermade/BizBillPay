...
class App extends Component {
  ...
  state = {
    ...
    bills: [
      {
        'id' : v4(),
        'BillName' : 'Portland Water',
        'BillLink' : 'https://www.portlandoregon.gov/water/',
        'DatePaid' : '3/5/2021',
        'DueDate' : '4/5/2021',
        'Paid' : false,
        'Phone' : "503-555-5555",
      ...
      },
      {
        'id' : v4(),
        'BillName' : 'PGE',
        'BillLink' : 'https://portlandgeneral.com/',
        'DatePaid' : '3/5/2021',
        'DueDate' : '4/5/2021',
        'Paid' : false,
        'Phone' : "503-555-5555",
        'Address' : '5555 SW Avery St',
        'Unit' : '',
        'City' : 'Tualatin',
        'State' : 'Oregon',
        'Zip' : '97062',
      ...
      {
        'id' : v4(),
        'BillName' : 'Allstate Insurance',
        'BillLink' : 'https://www.allstate.com/',
        'DatePaid' : '3/5/2021',
        'DueDate' : '4/5/2021',
        'Paid' : false,
        'Phone' : "503-555-5555",
      ...
      },
      {
        ...
        'BillLink' : 'https://www.nwnatural.com/',
        'DatePaid' : '3/5/2021',
        'DueDate' : '4/5/2021',
        'Paid' : false,
        'Phone' : "503-555-5555",
